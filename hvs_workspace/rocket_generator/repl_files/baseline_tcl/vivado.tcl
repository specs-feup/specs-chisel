...
add_files -norecurse -fileset $source_fileset $files
 ...
 #[file normalize "../../rocket-chip/src/main/resources/vsrc/SCIEDecoder.v"] \
 #[file normalize "../../rocket-chip/src/main/resources/vsrc/SCIEUnpipelined.v"] \
 #[file normalize "../../rocket-chip/src/main/resources/vsrc/SCIEPipelined.v"] \
