...
make implementation board=vc707 config=$config max_freqs_file=./results/max_freqs_${type_verbose_array[type]}.csv type=${type_verbose_array[type]} selected_frequency=200.0 order=$order
done
