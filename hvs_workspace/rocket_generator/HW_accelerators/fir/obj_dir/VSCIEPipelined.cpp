...
VL_INLINE_OPT void VSCIEPipelined::_sequent__TOP__1(VSCIEPipelined__Syms* __restrict vlSymsp) {
    ...
    VSCIEPipelined* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    VL_SIG(__Vdly__SCIEPipelined__DOT__data_0,31,0);
    VL_SIG(__Vdly__SCIEPipelined__DOT__data_1,31,0);
    VL_SIG(__Vdly__SCIEPipelined__DOT__data_2,31,0);
    // Body
    __Vdly__SCIEPipelined__DOT__data_1 = vlTOPp->SCIEPipelined__DOT__data_1;
    __Vdly__SCIEPipelined__DOT__data_2 = vlTOPp->SCIEPipelined__DOT__data_2;
    __Vdly__SCIEPipelined__DOT__data_0 = vlTOPp->SCIEPipelined__DOT__data_0;
    // ALWAYS at SCIEPipelined.v:39
    vlTOPp->SCIEPipelined__DOT__result = (((QData)((IData)(
							   vlTOPp->SCIEPipelined__DOT___GEN_27[2U])) 
					   << 0x3cU) 
					  | (((QData)((IData)(
							      vlTOPp->SCIEPipelined__DOT___GEN_27[1U])) 
					      << 0x1cU) 
					     | ((QData)((IData)(
								vlTOPp->SCIEPipelined__DOT___GEN_27[0U])) 
						>> 4U)));
    // ALWAYS at SCIEPipelined.v:39
    if (vlTOPp->valid) {
	...
	if ((0xbU == (0x7fU & vlTOPp->insn))) {
	    if ((1U == (3U & vlTOPp->rs2))) {
		vlTOPp->SCIEPipelined__DOT__coeffs_1 
		    = vlTOPp->rs1;
	    }
	}
    }
	...
	if ((0xbU == (0x7fU & vlTOPp->insn))) {
	    if ((2U == (3U & vlTOPp->rs2))) {
		vlTOPp->SCIEPipelined__DOT__coeffs_2 
		    = vlTOPp->rs1;
	    }
	}
    }
	...
	if ((0xbU == (0x7fU & vlTOPp->insn))) {
	    if ((3U == (3U & vlTOPp->rs2))) {
		vlTOPp->SCIEPipelined__DOT__coeffs_3 
		    = vlTOPp->rs1;
	    }
	}
    }
	...
	if ((0xbU != (0x7fU & vlTOPp->insn))) {
		...
		__Vdly__SCIEPipelined__DOT__data_0 
		    = vlTOPp->rs1;
	    }
	}
    }
	...
	if ((0xbU != (0x7fU & vlTOPp->insn))) {
	    if ((0x2bU == (0x7fU & vlTOPp->insn))) {
		__Vdly__SCIEPipelined__DOT__data_1 
	...
	if ((0xbU != (0x7fU & vlTOPp->insn))) {
	    if ((0x2bU == (0x7fU & vlTOPp->insn))) {
		__Vdly__SCIEPipelined__DOT__data_2 
		    = vlTOPp->SCIEPipelined__DOT__data_1;
	    }
	}
    }
    if (vlTOPp->valid) {
	if ((0xbU != (0x7fU & vlTOPp->insn))) {
	    if ((0x2bU == (0x7fU & vlTOPp->insn))) {
		vlTOPp->SCIEPipelined__DOT__data_3 
		    = vlTOPp->SCIEPipelined__DOT__data_2;
	    }
	}
    }
    vlTOPp->SCIEPipelined__DOT__data_1 = __Vdly__SCIEPipelined__DOT__data_1;
    vlTOPp->SCIEPipelined__DOT__data_2 = __Vdly__SCIEPipelined__DOT__data_2;
    vlTOPp->SCIEPipelined__DOT__data_0 = __Vdly__SCIEPipelined__DOT__data_0;
    vlTOPp->rd = (IData)(vlTOPp->SCIEPipelined__DOT__result);
    vlTOPp->SCIEPipelined__DOT___result_T_14 = (((VL_MULS_QQQ(64,64,64, 
						  ...
						  VL_MULS_QQQ(64,64,64, 
							      VL_EXTENDS_QI(64,32, vlTOPp->SCIEPipelined__DOT__data_1), 
							      VL_EXTENDS_QI(64,32, vlTOPp->SCIEPipelined__DOT__coeffs_1))) 
						 + 
						 VL_MULS_QQQ(64,64,64, 
							     VL_EXTENDS_QI(64,32, vlTOPp->SCIEPipelined__DOT__data_2), 
							     VL_EXTENDS_QI(64,32, vlTOPp->SCIEPipelined__DOT__coeffs_2))) 
						+ VL_MULS_QQQ(64,64,64, 
							      VL_EXTENDS_QI(64,32, vlTOPp->SCIEPipelined__DOT__data_3), 
							      VL_EXTENDS_QI(64,32, vlTOPp->SCIEPipelined__DOT__coeffs_3)));
}
...
void VSCIEPipelined::_settle__TOP__2(VSCIEPipelined__Syms* __restrict vlSymsp) {
    ...
    __Vtemp8[1U] = ((0x2bU == (0x7fU & vlTOPp->insn))
			 ...
			 ? (IData)((vlTOPp->SCIEPipelined__DOT___result_T_14 
				    >> 0x20U)) : ((0xfU 
						 ...
						 & vlTOPp->insn))
						   ...
						   (0xfU 
						    & VL_NEGATE_I((IData)(
									  (1U 
									   & (IData)(
										(vlTOPp->SCIEPipelined__DOT___result_T_14 
										>> 0x3fU))))))
						    : 
						   (0xfU 
						    & ((IData)(
								...
								>> 0x20U)) 
						       >> 0x1cU)))));
    vlTOPp->SCIEPipelined__DOT___GEN_27[0U] = ((IData)(vlTOPp->valid)
					        ? __Vtemp10[0U]
					        : (0xfffffff0U 
						   & ((IData)(vlTOPp->SCIEPipelined__DOT__result) 
						      << 4U)));
    vlTOPp->SCIEPipelined__DOT___GEN_27[1U] = ((IData)(vlTOPp->valid)
					        ? (
						   (0xbU 
						    == 
						    (0x7fU 
						   ...
						   | (0xfffffff0U 
						      & ((IData)(
								 (vlTOPp->SCIEPipelined__DOT__result 
								  >> 0x20U)) 
							 << 4U))));
    vlTOPp->SCIEPipelined__DOT___GEN_27[2U] = ((IData)(vlTOPp->valid)
					        ? __Vtemp10[2U]
					        : (0xfU 
						   & ((IData)(
							      (vlTOPp->SCIEPipelined__DOT__result 
...
VL_INLINE_OPT void VSCIEPipelined::_combo__TOP__3(VSCIEPipelined__Syms* __restrict vlSymsp) {
    ...
    // Body
    __Vtemp13[1U] = ((0xfU & ((IData)((((QData)((IData)(
							VL_NEGATE_I((IData)(
									    (1U 
									     & (((3U 
										== 
...
void VSCIEPipelined::_ctor_var_reset() {
    ...
    SCIEPipelined__DOT__coeffs_1 = VL_RAND_RESET_I(32);
    SCIEPipelined__DOT__coeffs_2 = VL_RAND_RESET_I(32);
    SCIEPipelined__DOT__coeffs_3 = VL_RAND_RESET_I(32);
    SCIEPipelined__DOT__data_0 = VL_RAND_RESET_I(32);
    SCIEPipelined__DOT__data_1 = VL_RAND_RESET_I(32);
    SCIEPipelined__DOT__data_2 = VL_RAND_RESET_I(32);
    SCIEPipelined__DOT__data_3 = VL_RAND_RESET_I(32);
    SCIEPipelined__DOT__result = VL_RAND_RESET_Q(64);
    SCIEPipelined__DOT___result_T_14 = VL_RAND_RESET_Q(64);
    VL_RAND_RESET_W(68,SCIEPipelined__DOT___GEN_27);
