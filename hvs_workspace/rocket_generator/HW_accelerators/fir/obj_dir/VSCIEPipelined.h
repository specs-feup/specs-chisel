...
VL_MODULE(VSCIEPipelined) {
  public:
    ...
    VL_SIG(SCIEPipelined__DOT__coeffs_1,31,0);
    VL_SIG(SCIEPipelined__DOT__coeffs_2,31,0);
    VL_SIG(SCIEPipelined__DOT__coeffs_3,31,0);
    VL_SIG(SCIEPipelined__DOT__data_0,31,0);
    VL_SIG(SCIEPipelined__DOT__data_1,31,0);
    VL_SIG(SCIEPipelined__DOT__data_2,31,0);
    VL_SIG(SCIEPipelined__DOT__data_3,31,0);
    VL_SIGW(SCIEPipelined__DOT___GEN_27,67,0,3);
    VL_SIG64(SCIEPipelined__DOT__result,63,0);
    VL_SIG64(SCIEPipelined__DOT___result_T_14,63,0);
