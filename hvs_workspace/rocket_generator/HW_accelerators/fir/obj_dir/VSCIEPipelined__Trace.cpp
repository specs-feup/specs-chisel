...
void VSCIEPipelined::traceChgThis__2(VSCIEPipelined__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus  (c+2,(vlTOPp->SCIEPipelined__DOT__coeffs_1),32);
	vcdp->chgBus  (c+3,(vlTOPp->SCIEPipelined__DOT__coeffs_2),32);
	vcdp->chgBus  (c+4,(vlTOPp->SCIEPipelined__DOT__coeffs_3),32);
	vcdp->chgBus  (c+5,(vlTOPp->SCIEPipelined__DOT__data_0),32);
	vcdp->chgBus  (c+6,(vlTOPp->SCIEPipelined__DOT__data_1),32);
	vcdp->chgBus  (c+7,(vlTOPp->SCIEPipelined__DOT__data_2),32);
	vcdp->chgBus  (c+8,(vlTOPp->SCIEPipelined__DOT__data_3),32);
	vcdp->chgQuad (c+9,(vlTOPp->SCIEPipelined__DOT__result),64);
    }
}
...
void VSCIEPipelined::traceChgThis__3(VSCIEPipelined__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+12,(vlTOPp->valid));
	vcdp->chgBus  (c+13,(vlTOPp->insn),32);
	vcdp->chgBus  (c+14,(vlTOPp->rs1),32);
	vcdp->chgBus  (c+15,(vlTOPp->rs2),32);
	vcdp->chgBus  (c+16,(vlTOPp->rd),32);
    }
}
